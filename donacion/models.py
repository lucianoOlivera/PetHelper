...
class Solicitud_Donacion_Monetaria(ClaseModelo):
    ...
    monto = models.FloatField(max_length=100, null=True, blank=False)
...
class Solicitud_Donacion_Insumo(ClaseModelo):
    titulo = models.TextField(max_length=100, null=True, blank=False)
    tipo_donacion = models.TextField(max_length=10,null=True, blank=False)

...
from usuario.views import MiActividad, RegistroUsuario, UsuarioDetail, UsuarioEdit, UsuarioPasswordEdit, UsuarioPasswordReset, UsuarioPasswordResetComplete, UsuarioPasswordResetConfirm, UsuarioPasswordResetDone, VerificarEmailMensage
...
urlpatterns = [
      ...
      path('usuario/actividad/<int:pk>', login_required(MiActividad.as_view()), name='usuario_actividad'),
